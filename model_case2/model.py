...
class FaultDetection:
    ...
    def train(self,train_x,train_y,val_x,val_y):
        ...
        self.loss=focal_loss(y_pred=self.softmax, y_true=tf.one_hot(tf.cast(self.label,tf.int32),2,1,0,-1),gamma=2,alpha=0.01)#+tf.contrib.layers.l2_regularizer(self.weight_decay)(self.fc_weight1)
